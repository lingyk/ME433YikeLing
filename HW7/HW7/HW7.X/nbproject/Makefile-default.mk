...
SOURCEFILES_QUOTED_IF_SPACED=main.c ili9341.c i2c_master.c imu.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.o ${OBJECTDIR}/ili9341.o ${OBJECTDIR}/i2c_master.o ${OBJECTDIR}/imu.o
POSSIBLE_DEPFILES=${OBJECTDIR}/main.o.d ${OBJECTDIR}/ili9341.o.d ${OBJECTDIR}/i2c_master.o.d ${OBJECTDIR}/imu.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.o ${OBJECTDIR}/ili9341.o ${OBJECTDIR}/i2c_master.o ${OBJECTDIR}/imu.o

# Source Files
SOURCEFILES=main.c ili9341.c i2c_master.c imu.c
...
${OBJECTDIR}/i2c_master.o: i2c_master.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/i2c_master.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/i2c_master.o.d" -o ${OBJECTDIR}/i2c_master.o i2c_master.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
