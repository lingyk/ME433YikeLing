...
int main() {
    ...
    LCD_axis(90,280,240,32,ILI9341_RED);
    LCD_plot(90,280,ILI9341_WHITE,red,240);
    
    LCD_axis(140,280,240,32,ILI9341_BLUE);
    LCD_plot(140,280,ILI9341_WHITE,blue,240);
    
    LCD_axis(190,280,240,32,ILI9341_GREEN);
    LCD_plot(190,280,ILI9341_WHITE,green,240);
